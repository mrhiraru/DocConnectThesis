...
?>
    <input type="radio" class="btn-check" name="time" id="time<?= $index ?>" autocomplete="off" value="<?= $time ?>" <?= (isset($appointment_time) && $appointment_time == $time) ? 'checked' : '' ?> onchange="set_value(this)">
