...
?>
                <div class="d-flex align-items-center justify-content-end mb-2" data-message-id="<?= $item['cb_message_id'] ?>">
                    <div class="bg-secondary text-light p-2 rounded-3 text-truncate" style="max-width: 52%; white-space: pre-wrap;"><?= $item['message'] ?></div>
                </div>
            <?php
            } else if ($item['message_type'] == "bot") {
            ?>
                <div class="d-flex align-items-center mb-2" data-message-id="<?= $item['cb_message_id'] ?>">
                    <div class="bg-primary text-light p-2 rounded-3 text-truncate" style="max-width: 52%; white-space: pre-wrap;"><?= $item['message'] ?></div>
                </div>
<?php
            }
        }
