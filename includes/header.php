	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
			<ul class="navbar-nav users_nav mb-2 mb-lg-0 header nav nav-pills">
				...
				<li class="nav-item"><a href="<?php echo (basename($_SERVER['PHP_SELF']) == 'FAQs.php') ? '../user/profile_appointment' : './profile_appointment'; ?>" class="nav-link text-primary d-flex justify-content-center	<?= $appointment ?>"><span class="text">Appointments</span></a></li>
