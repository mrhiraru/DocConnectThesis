            ...
            flatpickr("#appointment_date", {
                ...
                disable: [
                    function(date) {
                        ...
                        return formattedDate !== "<?= date('Y-m-d', strtotime($record['appointment_date'])) ?>" &&
                            (full_dates.includes(formattedDate) || getDisabledDays(startDay, endDay).includes(formattedDate));
                    }
                ],
