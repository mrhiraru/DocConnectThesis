                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="./appointment-view.php?account_id=<?= $_SESSION['account_id'] ?>&appointment_id=<?= $item['appointment_id'] ?>&referral=true" class="btn btn-info btn-sm text-light"><i class='bx bx-file-blank me-1'></i>Appointment Result</a>
