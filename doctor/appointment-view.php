                            ...
                            <div class="row col-12 mb-3 border-bottom">
                                ...
                                <?php if (!empty($record['prescription'])) : ?>
                                    <div class="col-12 mb-2">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control bg-light" id="prescription" name="prescription" readonly>Prescribed Medicine: <?= htmlspecialchars('\n' . $record['prescription'] ?? '') ?></textarea>
                                            <textarea class="form-control bg-light" id="dosage" name="dosage" readonly>Dosage: <?= htmlspecialchars('\n' . $record['dosage'] ?? '') ?></textarea>
                                            <textarea class="form-control bg-light" id="frequency" name="frequency" readonly>Frequency: <?= htmlspecialchars('\n' . $record['frequency'] ?? '') ?></textarea>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
